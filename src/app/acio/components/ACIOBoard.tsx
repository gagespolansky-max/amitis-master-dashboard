...
import { Deal, DealStage, DealPriority, STAGES, STAGE_LABELS } from "@/lib/types"
import DealCard from "./DealCard"
import DealPanel from "./DealPanel"
import BaselineReview from "./BaselineReview"
import { RefreshCw, Search, LayoutGrid, List, AlertCircle, Bell, Filter } from "lucide-react"
    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="shrink-0 px-6 py-4 border-b border-card-border flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-semibold">ACIO</h1>
